...
import { type GenericCohort, GenericCohortFromJSON, GenericCohortToJSON, isGenericCohort } from './GenericCohort.ts';
import { type BirthyearCohort, BirthyearCohortFromJSON, BirthyearCohortToJSON, isBirthyearCohort } from './BirthyearCohort.ts';
